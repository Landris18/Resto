            ...
            <Grid container rowSpacing={4}>
                ...
                <Grid item xs={12} sm={6} md={3} justifyContent="start" px={4}>
                    ...
                    <Stack spacing={3.5} mt={3}>
                        ...
                        <Stack direction={"row"} alignItems={"center"} columnGap={0.5}> <EmailIcon sx={{ color: 'white', fontSize: 16 }} /> <h5 style={{ color: 'white', margin: 0, wordBreak: "break-word" }}> landry.manankoraisina.rasendranirina@esti.mg</h5></Stack>
